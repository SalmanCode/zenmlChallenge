...
Almost a copy of:
https://github.com/pranavphoenix/VisionXformer/blob/main/Models/CCN.py with
    ...
    def __init__(
        ...
        if residual:
            ...
            self.res_conv = nn.Conv2d(heads, heads, (kernel_size, 1),
                                      padding=(padding, 0), groups=heads,
                                      bias=False)

    def forward(self, x, mask=None, return_attn=False):
        b, n, _, h, m, iters, eps = *x.shape, self.heads, self.num_landmarks,\
                                    self.pinv_iterations, self.eps
        ...
        # generate landmarks by sum reduction, and then calculate mean using
        # the mask
        ...
        # calculate landmark mask, and also get sum of non-masked elements in
        # preparation for masked mean
...
class TransformerEncoderLayer(nn.Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1,
        ...
        self.self_attn = NystromAttention(dim, dim_head=dim_head, heads=heads,
...
class Tokenizer(nn.Module):
        ...
        self.conv_layers = nn.Sequential(
            *[nn.Sequential(
                ...
                nn.MaxPool2d(kernel_size=pooling_kernel_size,
                             ...
                             padding=pooling_padding) if max_pool else
                nn.Identity()
            )
    ...
    def sequence_length(self, n_channels=3, height=224, width=224):
        return self.forward(torch.zeros((1, n_channels, height, width))).shape[
            1]
...
class TransformerClassifier(nn.Module):
    def __init__(self,
        ...
        dpr = [x.item() for x in
               torch.linspace(0, stochastic_depth_rate, num_layers)]
